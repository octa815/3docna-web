...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var translations = {
    es: {
      ...
      "nav.cta": "Pedir ahora",
      "hero.tag": "Impresión 3D en Elda · Campaña Halloween abierta",
      "hero.line1": "PIEZAS QUE",
      "hero.line2": "RESUELVEN.",
      "hero.sub": "Diseñamos y fabricamos en Elda piezas que resuelven algo: el soporte que tu bar necesita, la pieza que ya no fabrica nadie, el regalo que lleva el nombre de quien lo recibe. Presupuesto en 24 h.",
      "hero.btn1": "Ver catálogo",
      "hero.btn2": "Pieza a medida",
      "stat.presupuesto": "Presupuesto",
      "stat.local": "Fabricación local",
      "stat.custom": "A medida",
    ...
    en: {
      ...
      "nav.cta": "Order now",
      "hero.tag": "3D printing in Elda · Halloween campaign open",
      "hero.line1": "PARTS THAT",
      "hero.line2": "SOLVE IT.",
      "hero.sub": "We design and manufacture in Elda: the stand your bar needs, the part nobody makes any more, the gift with someone\u2019s name on it. Quote within 24 h.",
      "hero.btn1": "View catalog",
      "hero.btn2": "Custom part",
      "stat.presupuesto": "Quote",
      "stat.local": "Made locally",
      "stat.custom": "Custom",
